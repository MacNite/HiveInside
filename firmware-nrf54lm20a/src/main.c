 ...
 *
 * Alongside the plain readings it runs the shared vibration and acoustic FFT
 * band analysis, prints those bands, and broadcasts the reduced measurement in
 * HiveHub's BLE manufacturer-data format.
 */
#include "accel.h"
#include "battery.h"
#include "beacon.h"
