 ...
 * USB serial console. Alongside the plain readings it runs the shared vibration
 * and acoustic FFT band analysis, so a band value
 ...
 *   - LIS3DH / LIS2DH12 at 0x18/0x19 (an external breakout).
